...
const SignIn = () => {
  return (
    <div className="w-auto h-full -mt-4 ">
      ...
      <div className="font-Lato font-normal text-base leading-[19px] mt-2 text-white lg:text-black">
        Sign in to your account
      </div>

      <div className="flex flex-col lg:flex-row mt-8 items-center justify-between gap-2">
        <div className="flex w-full lg:w-auto px-5 py-2 hover:bg-gray-200 hover:text-gray-800 bg-white font-normal text-xs text-[#858585] font-montserrat rounded-xl items-center justify-around">
          <FcGoogle className="mr-3" size={20} />{" "}
          <button onClick={()=>signIn("google")} className="mr-2"> Sign in with Google</button>
        </div>
        <div className="flex w-full lg:w-auto px-4 py-2 bg-white font-normal text-xs hover:bg-gray-200 hover:text-gray-800 text-[#858585] font-montserrat rounded-xl items-center justify-around">
          <AiFillApple className="mr-3" size={20} />{" "}
          <span className="mr-2">Sign in with Apple</span>{" "}
        </div>
      </div>
      ...
      <form className="bg-white w-[80vw] lg:w-full rounded-xl mt-4 lg:mt-8 pb-10 lg:pb-0 p-4 relative">
        <div className="mb-6">
          ...
          <input
            type="email"
            id="email"
            className="bg-[#F5F5F5] border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            required
          />
        </div>
        <div className="mb-6">
