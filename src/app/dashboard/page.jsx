    ...
    <div className="m-10 bg-[#F8FAFF]">
      ...
      <div className="p-4 -mt-10 sm:ml-64">
          ...
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div className="flex md:order-2">
              ...
              <div className="relative hidden md:block">
                <input type="text" id="search-navbar" className="block w-full p-2 pl-4 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search..." />
        ...
        <div className="flex flex-col sm:flex-row gap-4 ">
          ...
          <a href="#" className="block w-full mr-5 sm:mr-0 sm:w-1/4 px-8 py-4  bg-white border border-gray-200 rounded-3xl shadow-lg hover:bg-gray-100">
            ...
            <div className="flex items-center justify-between">
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 mr-2">$2,128,430</h5>
          ...
          <a href="#" className="block w-full mr-5 sm:mr-0 sm:w-1/4 px-8 py-4  bg-white border border-gray-200 rounded-3xl shadow-lg hover:bg-gray-100">
            ...
            <div className="flex items-center justify-between">
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 mr-2">1,520</h5>
          ...
          <a href="#" className="block w-full mr-5 sm:mr-0 sm:w-1/4 px-8 py-4  bg-white border border-gray-200 rounded-3xl shadow-lg hover:bg-gray-100">
            ...
            <div className="flex items-center justify-between">
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 mr-2">9023</h5>
          ...
          <a href="#" className="block w-full mr-5 sm:mr-0 sm:w-1/4 px-8 py-4  bg-white border border-gray-200 rounded-3xl shadow-lg hover:bg-gray-100">
            ...
            <div className="flex items-center justify-between">
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 mr-2">9002</h5>
        ...
        <div className="block px-8 py-4 h-[75vh] w-full mt-10 bg-white border border-gray-200 rounded-3xl shadow-lg hover:bg-gray-100">
          <div className="flex justify-between items-center px-5 py-2">
            ...
            <div className="flex gap-x-2">
              <span className="flex items-center text-sm font-medium text-gray-900"><span className="flex w-2.5 h-2.5 bg-[#98D89E] rounded-full mr-1.5 flex-shrink-0"></span>Users</span>
              <span className="flex items-center text-sm font-medium text-gray-900"><span className="flex w-2.5 h-2.5 bg-[#EE8484] rounded-full mr-1.5 flex-shrink-0"></span>Guests</span>
            </div>
          </div>
          <UserGuestChart />
        </div>
          ...
          <div className="block w-full sm:w-1/2 px-8 py-4  bg-white border border-gray-200 rounded-3xl shadow-lg hover:bg-gray-100">
            ...
            <div className="flex items-center justify-center">
              ...
              <div className="flex flex-col gap-x-2">
                ...
                <span className="flex items-center text-sm font-medium text-gray-900"><span className="flex w-2.5 h-2.5 bg-[#EE8484] rounded-full mr-1.5 flex-shrink-0"></span>Super Hoodies</span>
              </div>
            </div>
          </div>
